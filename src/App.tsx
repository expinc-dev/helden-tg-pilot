  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-4 p-8">
      ...
      <div className="flex gap-4 text-sm">
        <Link className="underline" to="/host/new">Host: new session</Link>
        <Link className="underline" to="/join/central">Join as central</Link>
        <Link className="underline" to="/join/player">Join as player</Link>
      </div>
    </div>
  )
}
